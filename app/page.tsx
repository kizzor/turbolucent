...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#0F172A] text-[#F8FAFC] font-sans antialiased relative overflow-x-hidden pt-[80px]">
      ...
      {/* Header Navigation */}
      <header className="fixed top-0 left-0 w-full h-[80px] bg-[#0F172A]/60 backdrop-blur-md border-b border-white/10 z-[300] flex items-center pl-[240px]">
      ...
      <section id="home" className="py-24 border-b border-white/10 flex items-center relative min-h-[calc(100vh-80px)]">
        <div className="absolute top-0 left-0 w-full h-full opacity-30 bg-cover bg-bottom bg-no-repeat z-1" style={{ backgroundImage: "url('https://labs.google.com/pomelli_downloads/websites/90MDYs0lXoL4vts7yp_4q3/resources/a9kXuYP9U8Geh8yB27K_ua?authuser=0')" }} />
        <div className="max-w-[1200px] mx-auto px-8 relative z-10 text-center w-full">
          <span className="inline-block px-4 py-1.5 bg-[#06B6D4]/10 border border-white/10 text-[#06B6D4] rounded-full text-0.8rem font-medium tracking-widest uppercase mb-8 backdrop-blur-sm">
          ...
          <a href="https://t.me/c/2345641452/954" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold rounded-lg border border-[#06B6D4] bg-[#06B6D4]/5 text-[#F8FAFC] shadow-[0_0_15px_rgba(6,182,212,0.2)] hover:bg-[#06B6D4] hover:text-[#0F172A] hover:shadow-[0_0_20px_rgba(6,182,212,0.6)] transition-all">
      ...
      <section id="comparison" className="py-24 relative">
        ...
        <div className="max-w-[900px] mx-auto px-8 grid md:grid-cols-2 gap-8 relative z-10">
          <div className="p-10 rounded-xl bg-white/2 border border-white/10 backdrop-blur-md">
        ...
        <div className="max-w-[900px] mx-auto px-8 mt-16 text-center">
          <div className="inline-block p-6 bg-white/3 border border-white/10 backdrop-blur-md rounded-xl">
      ...
      <section id="what-we-do" className="py-24 relative">
        ...
        <div className="max-w-[1200px] mx-auto px-8 grid md:grid-cols-3 gap-8 relative z-10">
          {[
            ...
            <div key={idx} className="p-12 text-center bg-white/3 border border-white/10 backdrop-blur-md rounded-xl hover:bg-white/5 hover:border-[#06B6D4]/30 transition-all transform hover:-translate-y-1">
      ...
      <section id="showcase" className="py-24 relative border-t border-white/10">
        ...
        <div className="max-w-[1200px] mx-auto px-8 grid md:grid-cols-3 gap-8 relative z-10">
          {[
            ...
            <div key={idx} className="bg-white/3 border border-white/10 rounded-xl overflow-hidden hover:scale-[1.02] hover:border-[#06B6D4]/40 hover:shadow-[0_0_20px_rgba(6,182,212,0.15)] transition-all flex flex-col group cursor-pointer">
      ...
      <section id="showcase-hardware" className="py-24 border-t border-white/10 bg-gradient-to-t from-[#06B6D4]/2 to-transparent relative">
        <div className="max-w-[1200px] mx-auto px-8 text-center mb-16">
      ...
      <section id="platform" className="py-24 relative border-t border-white/10">
        <div className="max-w-[1200px] mx-auto px-8 grid md:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <div className="p-4 bg-white/3 border border-white/10 backdrop-blur-md rounded-xl shadow-2xl">
      ...
      <section id="architecture" className="py-24 border-t border-white/10 relative">
        ...
        <div className="max-w-[800px] mx-auto px-8 relative z-10">
          <div className="bg-[#0B1120] border border-white/10 rounded-xl shadow-2xl overflow-hidden">
            <div className="bg-white/3 px-4 py-3 flex gap-2 border-b border-white/10">
...
└── infrastructure/
    └── velocity.ts`}
      ...
      <section id="blogs" className="py-24 border-t border-white/10 bg-gradient-to-b from-[#06B6D4]/2 to-transparent relative">
        <div className="max-w-[1200px] mx-auto px-8 text-center mb-16">
        ...
        <div className="max-w-[1200px] mx-auto px-8 grid md:grid-cols-3 gap-8 relative z-10">
          {[
            ...
            <article key={idx} className="bg-white/3 border border-white/10 rounded-xl overflow-hidden hover:scale-[1.02] hover:border-[#06B6D4]/30 hover:shadow-[0_0_20px_rgba(6,182,212,0.1)] transition-all flex flex-col">
